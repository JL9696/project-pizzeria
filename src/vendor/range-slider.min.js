      ...
      function (t, e, i) {
        ...
        (e.uuid = function () {
          ...
          (e.delay = function (t, e) {
            for (
              var i = arguments.length, n = Array(2 < i ? i - 2 : 0), s = 2;
              s < i;
              s++
            )
              n[s - 2] = arguments[s];
        ...
        var n = (e.isString = function (t) {
          ...
          r =
            ...
            (e.isNumberLike = function (t) {
              return (
                null != t && ((n(t) && isFinite(parseFloat(t))) || isFinite(t))
              );
            }));
              ...
              if (
                ...
                (this.options.buffer =
                  ...
                  (this.value = h.getFirsNumberLike(
                    ...
                    this.element.value,
                    parseFloat(
                      this.element.value || this.min + (this.max - this.min) / 2
                    )
                  )),
                ...
                o && 0 < o.length && this.range.setAttribute('title', o),
                  ...
                  h.isNumberLike(this.options.value) &&
                    (this._setValue(this.options.value, !0),
                    (this.element.value = this.options.value)),
                  h.isNumberLike(this.options.buffer) &&
                    this.element.setAttribute('data-buffer', this.options.buffer),
                  h.isNumberLike(this.options.min) &&
                  ...
                  (this._startEventListener =
                    this._startEventListener.bind(this)),
                  (this._changeEventListener =
                    this._changeEventListener.bind(this)),
                      ...
                      return (
                        ...
                        h.isObject(t) &&
                          (h.isNumberLike(t.min) &&
                            (this.element.setAttribute('min', '' + t.min),
                            (this.min = t.min)),
                          h.isNumberLike(t.max) &&
                            (this.element.setAttribute('max', '' + t.max),
                            (this.max = t.max)),
                          h.isNumberLike(t.step) &&
                            (this.element.setAttribute('step', '' + t.step),
                            (this.step = t.step),
                            (this.toFixed = this._toFixed(t.step))),
                          h.isNumberLike(t.buffer) &&
                            this._setBufferPosition(t.buffer),
                  ...
                  },
                  {
                    ...
                    value: function (t) {
                      if (
                        ...
                        this._setPosition(r),
                          s <= i &&
                            i < s + 2 * this.options.borderRadius &&
                            (this.grabX = i - s),
                          this._updatePercentFromValue();
                      }
                    },
                  ...
                  },
                  {
                    ...
                    value: function (t) {
                      var e,
                        ...
                        n = void 0,
                        s = void 0,
                        r = this._getValueFromPosition(
                          h.between(t, 0, this.maxHandleX)
                        );
                      this.stick &&
                        ((n = r % (s = this.stick[0])) <
                        (i = this.stick[1] || 0.1)
                  ...
                  },
                  {
                    ...
                    value: function (t) {
                      ...
                      if (isFinite(t)) t = parseFloat(t);
                        ...
                        if (!h.isString(t))
                          return void console.warn(
                            'New position must be XXpx or XX%'
                          );
                      ...
                      if (isNaN(t)) console.warn('New position is NaN');
                        ...
                        var n =
                            (this.options.borderRadius / this.rangeSize) * 100,
                          s = i - n;
                        s < 0 && (s = 0),
                          this.vertical
                        ...
                        console.warn(
                          "You disabled buffer, it's className is empty"
                        );
                    },
                  },
                  {
                    ...
                    value: function (t) {
                      for (
                        var e = this.vertical ? this.maxHandleX : 0;
                        null !== t;
                    ...
                    value: function (t) {
                      ...
                      return (
                        void 0 !== t[s]
                          ...
                          : t.touches &&
                            t.touches[0] &&
                            void 0 !== t.touches[0][s]
                          ? (n = t.touches[0][s])
                          : !t.currentPoint ||
                            (void 0 === t.currentPoint.x &&
                              void 0 === t.currentPoint.y) ||
                            (n = this.vertical
                              ? t.currentPoint.y
                              : t.currentPoint.x),
                  ...
                  },
                  {
                    ...
                    value: function (t) {
                      var e = t / (this.maxHandleX || 1),
                        i =
                          this.step *
                            Math.round((e * (this.max - this.min)) / this.step) +
                          this.min;
      ...
      function (t, e, i) {
        ...
        (e.addClass = function (t, e) {
          ...
          (e.removeAllListenersFromEl = function (e, t) {
            ...
            function n(t) {
              t === e._startEventListener &&
                this.el.removeEventListener(this.eventName, t, !1);
            }
          }),
